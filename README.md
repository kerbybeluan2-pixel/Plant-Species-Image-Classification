...
This project focuses on building an image classification model using Teachable Machine to identify different types of creeper plants. The dataset includes 5,000 images, with 250 images for each plant type, ensuring balanced training and minimizing bias. The images capture the plants from various angles, lighting conditions, and backgrounds, allowing the model to recognize real-world variations in leaves, stems, and growth patterns.

The images are organized into labeled categories and uploaded to Teachable Machine for training, testing, and validation. The main goal is to create an AI model that can automatically classify creeper plants accurately and efficiently, supporting applications such as plant identification, educational demonstrations, and introductory computer vision projects.
...
<img width="379" height="895" alt="Screenshot 2026-02-16 184128" src="https://github.com/user-attachments/assets/4a764def-6845-4c4d-9004-f2191f9a09e5" />
...
**Answer:** The number of images per class had a significant impact on the model’s accuracy. Having a balanced dataset ensured that the model could learn each class properly, reducing bias and improving classification performance.

**2. Which plant species were most commonly misclassified and why?**
**Answer:** The ivy gourd was most frequently misclassified. This is because its visual features, such as leaf color and shape, are very similar to other creeper plants, making it difficult for the model to distinguish it accurately.
